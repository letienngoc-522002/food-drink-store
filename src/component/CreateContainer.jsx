...
export default function CreateContainer() {
  ...
  return (
    <div className="flex w-full min-h-screen items-center justify-center">
      <div className="flex flex-col w-[90%] md:w-[75%] border-gray-400 rounded-lg p-4 items-center justify-center gap-4">
        {
          fields && (
          <motion.p
              initial={{ opacity: 0 }}
        ...
        <div className="flex flex-col group 
            w-full h-225 md:h-420 cursor-pointer border-2 
            border-groove border-gray-300 rounded-lg 
